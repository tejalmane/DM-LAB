...
public class expt_10 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            File excel = new File("./demo/Experiment 10/data_file.xlsx");
        ...
        for (Map.Entry<String, String> e : data_file.entrySet()) {
            ...
            // // String[] tmp = e.getValue().split(" ");
            // // int[] pt = new int[2];
            // // pt[0] = Integer.parseInt(tmp[0]);
            // // pt[1] = Integer.parseInt(tmp[0]);
            // for (int i = 0; i < cnt_of_dist_pt; i++) {
        ...
        try {
            ...
            FileOutputStream out = new FileOutputStream(
                    new File("./demo/Experiment 10/output_file.xlsx"));
            workbook.write(out);
