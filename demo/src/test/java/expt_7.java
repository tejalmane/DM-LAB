...
//association rule for given transaction data
public class expt_7 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        // File file = new File("D:\\DM lab\\Experiment 6\\Apriori.txt");
        // ------------------
        Scanner sc = new Scanner(new File("./demo/Experiment 7/data_file.txt"));
        ...
        expt_7 a = new expt_7();
        a.display(noOfTransactions, transactions, minimumSupport,
                minimumConfidence);
    }
            ...
            for (int i = 0; i < candidates.size(); i++) {
                for (int j = i + 1; j < candidates.size(); j++) {
                    ...
                    if (s2.compareToIgnoreCase(s1) == 0) {
                        String addString = (s1 + " " + strToken1.nextToken()
                                + " " + strToken2.nextToken()).trim();
                        candidatesTemp.add(addString);
                    }
                }
            }
            ...
            } else /* for FrequentItemSet > 2 */
            {
                for (int a = 0; a < wordCountInString - 1; a++) {
                    ...
                    if (confidence1 >= minimumConfidence) {
                        System.out.println(st + " -> " + str + " = Confidence =" + confidence1 * 100 + " and Support = "
                                + (int) value + "");
                    }
                    str1 = "";
                }
